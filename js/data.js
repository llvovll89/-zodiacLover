...
const qnaList = [
    ...
    },
    {
      ...
      a: [
        { answer: 'a. 박력 그 자체, "나랑 밥도먹고 뽀뽀도하자!" ', type: [1, 2, 4 ] },
        { answer: 'b. 섬세한 "나사실,,너 많이 좋아해 우리 사귈래??" ', type: [7, 10, 8, 9, 11 ] },
    ...
    },
    {
      ...
      a: [
        { answer: 'a. 쑥스러워.. 정수리터치,,', type: [1, 7, 10, 4, 9 ] },
        { answer: 'b. 허용범위 ON, 뽀뽀까지 가능해!', type: [0, 3, 6, 11]},
  ...
  
    {
      ...
      a: [
        { answer: 'a. 무슨 기념일이야, 평범하게 넘어가자,,', type: [4, 9, 11 ] },
        { answer: 'b. 맛있는 밥이나 사줄까? 아니면 예쁜 꽃이라도?', type: [0, 3, 6, 10 ] },
        { answer: 'c. 이벤트 준비완료! 출격준비!', type: [1, 7, 2, 5, 8 ] },
      ]
    },
    {
    ...
    {
      q: 'Q12. 연인과 데이트 도중 화를 참을 수 없을만큼 심하게 싸웠다. 어떻게 할 것인가?',
      a: [
